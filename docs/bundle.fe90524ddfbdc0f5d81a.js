!(function (e) {
  ...
  function (e, a, n) {
    "use strict";
    n.r(a), (a.default = n.p + "0379613a4269155f45b325b9c8ade309.svg");
  },
  function (e, a, n) {
    "use strict";
    n.r(a), (a.default = n.p + "92e4eecf1c83293e3395a3cd1b84693b.svg");
  },
  function (e, a, n) {
    "use strict";
    n.r(a), (a.default = n.p + "b8b7453248e1707d44a072fa15bea3f9.svg");
  },
  function (e, a, n) {
    "use strict";
    n.r(a), (a.default = n.p + "9ae79499243776a4de6e6a6c25ec9798.svg");
  },
  function (e, a, n) {
    "use strict";
    n.r(a), (a.default = n.p + "3392ebef20e51148368ecc5969498f64.svg");
  },
  function (e, a, n) {
    "use strict";
    n.r(a), (a.default = n.p + "b33cd68d7fb870c5930919ddfc0933b1.svg");
  },
  function (e, a, n) {
    "use strict";
    n.r(a), (a.default = n.p + "a97a2e9fa184dcab972b10738af89c32.svg");
  },
  function (e, a, n) {
    "use strict";
    n.r(a), (a.default = n.p + "61e5b40f641dff097d3fe85e9fa07beb.svg");
  },
  function (e, a, n) {
    "use strict";
    n.r(a), (a.default = n.p + "7d600c80a7f5f31bc33716b7d9b72515.svg");
  },
  function (e, a, n) {
    "use strict";
    n.r(a), (a.default = n.p + "4c0ad8f5f10199effb77a3e746d0ff55.svg");
  },
  function (e, a, n) {
    var t = n(13),
      o = n(14);
  ...
  function (e, a, n) {
    ...
    function l(e, a) {
      for (var n = {}, t = [], o = 0; o < e.length; o++) {
        ...
        -1 !== c
          ? (s[c].references++, s[c].updater(u))
          : s.push({ identifier: d, updater: y(u, a), references: 1 }),
          t.push(d);
      }
      return t;
    }
    ...
    var d,
      c =
        ((d = []),
        function (e, a) {
          return (d[e] = a), d.filter(Boolean).join("\n");
        });
    function u(e, a, n, t) {
      var o = n
        ? ""
        ...
        : t.css;
      if (e.styleSheet) e.styleSheet.cssText = c(a, o);
      else {
        var i = document.createTextNode(o),
          s = e.childNodes;
        s[a] && e.removeChild(s[a]),
          s.length ? e.insertBefore(i, s[a]) : e.appendChild(i);
      }
    }
    function m(e, a, n) {
      var t = n.css,
    ...
    e.exports = function (e, a) {
      ...
      return function (e) {
        if (
          ...
          for (var i = l(e, a), h = 0; h < n.length; h++) {
            var d = r(n[h]);
  ...
  function (e, a, n) {
      ...
      s = (function () {
        function e() {
          ...
          t(this, e),
            (this.name = a),
            i[a]
              ? (this.img = i[a].cloneNode())
              : ((this.img = new Image()),
                (this.img.src = n(1)("./".concat(a, ".svg")).default),
                (i[a] = this.img));
        }
        var a, s, r;
        return (
      ...
      function e(a, n, t) {
        ...
        !(function (e, a) {
          ...
          t.forEach(function (e) {
            return o.symbolContainer.appendChild(new s(e).img);
          });
      }
      var a, n, t;
      return (
        ...
        (n = [
          {
            ...
            value: function (e) {
              for (
                var a = document.createDocumentFragment(), n = 3;
              ...
              this.symbolContainer.appendChild(a);
            },
          },
          {
            key: "spin",
            value: function () {
              var e = this,
                a = new Promise(function (a) {
                  return (e.animation.onfinish = a);
                }),
                n = new Promise(function (a) {
                  return setTimeout(a, 1e3 * e.factor);
                });
              return (
                this.animation.play(),
                Promise.race([a, n]).then(function () {
                  ...
                  for (
                    var a = e.symbolContainer.children.length - 3, n = 0;
                    n < a;
                    n++
                  )
      ...
      function e(a) {
        ...
        h(this, e),
          ...
          (this.reels = Array.from(
            ...
            return new l(e, a, n.currentSymbols[a]);
          })),
          ...
          t.inverted && this.container.classList.add("inverted"),
          (this.facts = [
        ...
        (n = [
          ...
          },
          {
            ...
            value: function () {
              ...
              return (
                this.onSpinStart(),
                Promise.all(
                  this.reels.map(function (a) {
                    return a.renderSymbols(e.nextSymbols[a.idx]), a.spin();
                  })
                ).then(function () {
                  return e.onSpinEnd();
                })
          ...
          },
          {
            ...
            value: function () {
              ...
              this.nextSymbols = a[Math.floor(Math.random() * a.length)];
            },
          },
          {
            key: "checkWin",
            value: function () {
              var e = !1,
                a = this.nextSymbols[0][0],
                n = this.nextSymbols[1][0],
                t = this.nextSymbols[2][0],
                o = this.nextSymbols[3][0],
                i = this.nextSymbols[4][0],
                s = this.nextSymbols[0][1],
                r = this.nextSymbols[1][1],
                l = this.nextSymbols[2][1],
                h = this.nextSymbols[3][1],
                d = this.nextSymbols[4][1],
                c = this.nextSymbols[0][2],
                u = this.nextSymbols[1][2],
                m = this.nextSymbols[2][2],
                f = this.nextSymbols[3][2],
                p = this.nextSymbols[4][2];
              a === n && a === t && a === o && a === i && (e = !0),
                s === r && s === l && s === h && s === d && (e = !0),
                c === u && c === m && c === f && c === p && (e = !0),
                a === r && a === m && a === h && a === i && (e = !0),
                c === r && c === t && c === h && c === p && (e = !0),
                e && (this.displayWin(), this.resetNextWin());
            },
          },
          {
            key: "displayWin",
            value: function () {
              var e = document.getElementById("modal-content"),
                a = document.getElementById("goodbye");
              this.firstWin
                ? ((this.firstWin = !1), (a.style.display = "block"))
                : (a.style.display = "none"),
                (e.innerHTML = this.facts[
    ...
    var c = document.getElementById("uselessFacts");
    window.onclick = function (e) {
      e.target === c && (c.style.display = "none");
    };
  },
]);
